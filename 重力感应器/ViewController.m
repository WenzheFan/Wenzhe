...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    //召唤加速度传感器//'UIAccelerometer' is deprecated: first deprecated in iOS 5.0 - UIAccelerometer has been replaced by the CoreMotion framework
...
-(void)viewWillDisappear:(BOOL)animated
{
    ...
    //不要忘了停止传感器的工作
    //结束加速度传感器的工作
    _speedX = _speedY = 0;//'UIAccelerometer' is deprecated: first deprecated in iOS 5.0 - UIAccelerometer has been replaced by the CoreMotion framework
    UIAccelerometer *accelerometer = [UIAccelerometer sharedAccelerometer];
...
- (IBAction)button:(id)sender {
    [self presentViewController:[[SaViewController alloc]init] animated:YES completion:nil];
}
